...
function lazyload_images()
{
    ...
    add_action('wp_head', 'setup_filters', PHP_INT_MAX);

    // Do not lazy load avatar in admin bar.
    add_action('admin_bar_menu', 'remove_filters', 0);
    add_filter('wp_kses_allowed_html', 'allow_lazy_attributes');

}

add_action('wp', 'lazyload_images');
...
{
    remove_filter('the_content', 'add_image_placeholders', PHP_INT_MAX);
    remove_filter('post_thumbnail_html', 'add_image_placeholders', PHP_INT_MAX);
    remove_filter('get_avatar', 'add_image_placeholders', PHP_INT_MAX);
    remove_filter('widget_text', 'add_image_placeholders', PHP_INT_MAX);
    remove_filter('get_image_tag', 'add_image_placeholders', PHP_INT_MAX);
    remove_filter('wp_get_attachment_image_attributes', 'process_image_attributes', PHP_INT_MAX);
}
 ...
 */
function process_image_attributes($attributes, $attachment)
{
    ...
    $attributes['src'] = get_placeholder_image($attachment->ID);
 ...
 */
function get_placeholder_image($id)
{
