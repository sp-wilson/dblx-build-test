...
<html <?php language_attributes(); ?> class="no-js">
    ...
    <body <? body_class('js-page'); ?>itemscope itemtype="http://schema.org/WebPage">
        ...
        <iframe src="<?= get_template_directory_uri(); ?>/assets/img/icons.svg" onload="document.body.insertAdjacentElement('afterbegin', this.contentDocument.childNodes[0]); document.body.removeChild(this);" style="display: none"></iframe>
